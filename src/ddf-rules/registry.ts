...
export const WAFFLE_SERVER_TAG = Symbol.for('WAFFLE_SERVER');
...
export const tags: any = {
  [UNEXPECTED_DATA]: [FILE_SYSTEM_TAG, WAFFLE_SERVER_TAG],
  ...
  [CONCEPT_ID_IS_NOT_UNIQUE]: [WAFFLE_SERVER_TAG],
  [EMPTY_CONCEPT_ID]: [WAFFLE_SERVER_TAG],
  [INCORRECT_IDENTIFIER]: [WAFFLE_SERVER_TAG],
  [NON_CONCEPT_HEADER]: [WAFFLE_SERVER_TAG],
  [INVALID_DRILL_UP]: [WAFFLE_SERVER_TAG],
  [MEASURE_VALUE_NOT_NUMERIC]: [WARNING_TAG, DATAPOINT_TAG],
  [DATA_POINT_UNEXPECTED_ENTITY_VALUE]: [WAFFLE_SERVER_TAG, DATAPOINT_TAG],
  [DATA_POINT_UNEXPECTED_TIME_VALUE]: [WAFFLE_SERVER_TAG, DATAPOINT_TAG],
  [WRONG_DATA_POINT_HEADER]: [WAFFLE_SERVER_TAG, DATAPOINT_TAG],
  [WRONG_ENTITY_IS_HEADER]: [],
  [WRONG_ENTITY_IS_VALUE]: [],
  [NON_UNIQUE_ENTITY_VALUE]: [WAFFLE_SERVER_TAG],
  [CONCEPT_MANDATORY_FIELD_NOT_FOUND]: [WAFFLE_SERVER_TAG],
  [CONCEPTS_NOT_FOUND]: [WAFFLE_SERVER_TAG],
  [DATAPACKAGE_CONFUSED_FIELDS]: [WAFFLE_SERVER_TAG],
  [DATAPACKAGE_NON_CONCEPT_PRIMARY_KEY]: [WAFFLE_SERVER_TAG],
  [DATAPACKAGE_NON_UNIQUE_RESOURCE_NAME]: [WAFFLE_SERVER_TAG],
  [DATAPACKAGE_NON_UNIQUE_RESOURCE_FILE]: [WAFFLE_SERVER_TAG],
  [UNEXPECTED_TRANSLATION_HEADER]: [WAFFLE_SERVER_TAG, TRANSLATION_TAG],
  [UNEXPECTED_TRANSLATIONS_DATA]: [WAFFLE_SERVER_TAG, TRANSLATION_TAG],
  ...
  [DUPLICATED_TRANSLATION_KEY]: [WAFFLE_SERVER_TAG, TRANSLATION_TAG]
};
