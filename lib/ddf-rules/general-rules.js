...
function getNonIndexFileDescriptors(ddfDataSet) {
  return _.reduce(
    ddfDataSet.ddfRoot.directoryDescriptors.filter(directoryDescriptor =>
    directoryDescriptor.isDDF && !directoryDescriptor.ddfIndex.exists),
...
module.exports = {
  ...
  [registry.FILENAME_DOES_NOT_MATCH_HEADER]: ddfDataSet =>
